      ...
      <div className="container mx-auto px-4 mb-20">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-8 tracking-tight">
            Stay <span className="text-sky-400">Informed</span>
          </h1>
          
          <p className="text-slate-400 text-lg md:text-xl mb-12 leading-relaxed">
            Get the latest information about government jobs, scheme deadlines, and new services added to Sultan Digital Zone.
          </p>
