...
export default function Home() {
  ...
  whileTap={{ scale: 0.9 }}
  className="fixed bottom-6 right-6 z-40 w-14 h-14 bg-green-500 rounded-full flex items-center justify-center shadow-2xl shadow-green-500/30 hover:bg-green-600 transition-all"
>
  <img src="/whatsappicon.jpg" alt="WhatsApp" className="w-7 h-7" />
</motion.a>
